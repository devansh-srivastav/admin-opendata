...
export default function Home() {
  ...
  useEffect(()=>{
    ...
    const decline = () => {
        ...
        let res = axios.post(apiUrl + "decline",query , { headers: header }).then(async (res) => {
            if (res.status == 200) {
